...
?>
    ...
    <a href="global/vaciar_carro.php" class="btn btn-warning" role="button">Vaciar carrito</a>
        ...
        <?php foreach($listaArticulos as $Articulo){ ?>
            ...
            <div class="col-3">
                <div class="card" style="text-align: center;">
                    ...
                    <img title="" class="card-img-top" src="img/utilesescolares.png" height="250px;">
                    <div class="card-body">
