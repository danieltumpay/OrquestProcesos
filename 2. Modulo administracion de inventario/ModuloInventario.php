...
$connection = new AMQPStreamConnection('beaver.rmq.cloudamqp.com', 5672, 'pavrucat', 'QXLlQj6EJRJmy7eahmDg0DKfkF3w_zX6','pavrucat');
...
$callback = function ($msg) {
    ...
    //Verificacion a la base de datos sobre stock
        ...
        if($respuesta==true){
            ...
            //echo $json;
            $connection2 = new AMQPStreamConnection('beaver.rmq.cloudamqp.com', 5672, 'pavrucat', 'QXLlQj6EJRJmy7eahmDg0DKfkF3w_zX6','pavrucat');
            ...
            $connection3 = new AMQPStreamConnection('beaver.rmq.cloudamqp.com', 5672, 'pavrucat', 'QXLlQj6EJRJmy7eahmDg0DKfkF3w_zX6','pavrucat');
